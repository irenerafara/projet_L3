...
$('.btn-edit').on('click', function() {
    ...
    $('#NumCarte').val(tr.find('td').eq(2).html())
    $('#DateDemandeCarte').val(tr.find('td').eq(4).html())
    $('#DateObtentionCarte').val(tr.find('td').eq(5).html())
    $('#DateExpirationCarte').val(tr.find('td').eq(6).html())
    $('#StatutCarte').val(tr.find('td').eq(7).html())
