        ...
        <table class="table table-bordered" IDOrpailleur="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            <?php foreach($orpailleurs as $orpailleur){
              ...
              <tr id = "orpailleur-<?php echo $IDOrpailleur; ?>">
                ...
                <td><?php echo $DuplicataCINOrpailleur; ?></td>
                <td><?php echo $ContactOrpailleur; ?></td>
                <td><?php echo $AdresseOrpailleur; ?></td>
                
                <td> 
                  <div class = "btn-group">
                    <button class = "btn btn-sm btn-primary btn-edit" onClick = "edit_orpailleur(<?php echo $IDOrpailleur; ?>)"><i class="fas fa-pencil-alt"></i></button> 
                    <button class = "btn btn-sm btn-danger btn-remove" onClick = "delete_orpailleur(<?php echo $IDOrpailleur; ?>)"><i class="fas fa-trash"></i></button> 
                  </div>
                </td>
              </tr>
            <?php } ?>
