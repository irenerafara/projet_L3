...
<a class="navbar-brand mr-1" href="index.html">ANOR</a>
...
<form method = "POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
  <div class="input-group">
    <input type="text" value = "<?php echo isset($search_criteria) ? $search_criteria : '' ?>" name = "search" class="form-control" placeholder="Recherche" aria-label="Search" aria-describedby="basic-addon2">
