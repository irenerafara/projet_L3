      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group form-inline">
              ...
              <input type="text" class="form-control" id="NomCollecteurCat1" name="NomCollecteurCat1" aria-describedby="NomHelp" placeholder="" required>
          </div>
          <div class="form-group form-inline">
              <label class = "col-sm-6" for="PrenomCollecteurCat1">Prénom</label>
              <input type="text" class="form-control"  id="PrenomCollecteurCat1" name = "PrenomCollecteurCat1" placeholder=""required>
          </div>
          <div class="form-group form-inline">
          ...
          <div class="form-group form-inline">
              ...
              <input type="text" class="form-control"  id="LieuCINCollecteurCat1" name="LieuCINCollecteurCat1" placeholder="" required>
          </div>
          
          <div class="form-group form-inline">
              <label class = "col-sm-6" for="DateCINCollecteurCat1">Date CIN</label>
              <input type="date" class="form-control" id="DateCINCollecteurCat1" name="DateCINCollecteurCat1" placeholder="" required>
          </div>
          <div class="form-group form-inline">
              <label class = "col-sm-6" for="DuplicataCINCollecteurCat1">Duplicata</label>
              <input type="date" class="form-control" id="DuplicataCINCollecteurCat1" name="DuplicataCINCollecteurCat1" placeholder="" required>
          </div>
          <div class="form-group form-inline">
              <label class = "col-sm-6" for="ContactCollecteurCat1">Contact</label>
              <input type="text" class="form-control" validation-type = "phone-number" id="ContactCollecteurCat1" name="ContactCollecteurCat1" placeholder="" required>
              <small class = "form-text text-muted error"></small>
          </div>
          <div class="form-group form-inline">
              <label class = "col-sm-6" for="AdresseCollecteurCat1">Adresse</label>
              <input type="text" class="form-control" id="AdresseCollecteurCat1" name="AdresseCollecteurCat1" placeholder="" required>
          </div>
